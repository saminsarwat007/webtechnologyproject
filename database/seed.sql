...
-- LABELS  (M8 — Monika)
-- ------------------------------------------------------------------
INSERT INTO labels (label_id, name, created_by) VALUES
  (1, 'Interview Tips',     2),
  (2, 'Resume Advice',      2),
  (3, 'Internship Stories', 3),
  (4, 'Salary & Offers',    3),
  (5, 'Companies',          4);
...
-- POSTS  (M7 — Monika)
-- ------------------------------------------------------------------
INSERT INTO posts (post_id, user_id, label_id, title, content, likes) VALUES
  (1, 3, 1, 'How do you prepare for technical interviews at Malaysian tech companies?',
     'I have an interview lined up next month with TechCorp. Has anyone here done a system design or coding interview with them? Any tips on what to focus on — algorithms, system design, or behavioural rounds?', 3),
  (2, 4, 2, 'Resume tips for fresh graduates with no work experience',
     'My CV currently only lists my university projects and some MOOCs. How do I make it stand out for software engineering internships? Should I include side projects, hackathons, or open-source contributions?', 5),
  (3, 3, 3, 'My summer internship at Petronas ICT — AMA',
     'Just finished a 10-week backend internship at Petronas ICT. Happy to answer questions about the application process, the team, the work, and what to expect. AMA!', 8),
  (4, 4, 4, 'What is a fair starting salary for a fresh SE graduate in KL?',
     'Recruiters keep asking my expected salary and I have no idea what is fair for an entry-level software engineer in Kuala Lumpur in 2026. Would love to hear what offers you have seen or received.', 2),
  (5, 3, 5, 'Axiata Digital — is it worth applying as a frontend developer?',
     'Looking at the Frontend Developer posting at Axiata Digital. Anyone here worked there or knows someone who has? Curious about culture, tech stack, and growth opportunities.', 1);
...
-- -----------------------------------------------------------------------
-- M8 — Interview slots (admin creates these)
-- -----------------------------------------------------------------------
INSERT INTO interview_slots (slot_id, interviewer_id, scheduled_at, is_booked) VALUES
(1, 2, DATE_ADD(NOW(), INTERVAL 3 DAY),  FALSE),
(2, 2, DATE_ADD(NOW(), INTERVAL 5 DAY),  TRUE),
(3, 2, DATE_ADD(NOW(), INTERVAL 7 DAY),  FALSE),
(4, 2, DATE_ADD(NOW(), INTERVAL 10 DAY), TRUE),
(5, 2, DATE_ADD(NOW(), INTERVAL 12 DAY), FALSE),
(6, 2, DATE_ADD(NOW(), INTERVAL 14 DAY), FALSE),
(7, 2, DATE_ADD(NOW(), INTERVAL 17 DAY), TRUE);

-- -----------------------------------------------------------------------
-- M8 — Mock interviews (bookings by students)
-- -----------------------------------------------------------------------
INSERT INTO mock_interviews (interview_id, slot_id, student_id, job_category, status, feedback_text, score) VALUES
(1, 2, 3, 'Software Engineering', 'completed',
 'Areeb demonstrated strong problem-solving skills and clean code structure. Needs to work on time complexity analysis and communicating thought process more clearly during live coding.',
 78),

(2, 4, 4, 'UI/UX Design', 'completed',
 'Samin showed excellent understanding of user-centred design principles. Portfolio presentation was confident. Should practise more on design system questions and accessibility standards.',
 85),

(3, 7, 3, 'Data Science', 'pending', NULL, NULL);
